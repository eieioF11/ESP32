...
class MPU9250
{
  private:
    ...
    volatile float diffX = 0;
    volatile float diffY = 0;
    volatile float diffZ = 0;

    volatile float gyroX = 0;//ジャイロセンサから求めた角速度
    volatile float gyroY = 0;//ジャイロセンサから求めた角速度
    volatile float gyroZ = 0;//ジャイロセンサから求めた角速度

    volatile float degx = 0;//ジャイロセンサから求めた角度
    volatile float degy = 0;//ジャイロセンサから求めた角度
    volatile float degz = 0;//ジャイロセンサから求めた角度
