...
//User Settings------------------------------------
#define ESP_MODE        NONE             //ESP_PS3:PS3 ESP_BTS: BluetoothSerial, ESP_NONE: NONE
...
#define DEFAULTTASK     OFF              //Set up a task for testing(test,wificontroller or PS3controller)
#define STARTTASK       0                //0 setuptask,1 contorollertask
#define I2CPORT         OFF               //using i2c port
#define SD              OFF              //SD card activation
#define ROS             OFF               //Enable ROS
#define ROSdatasize     6                //ROS transmission data size [byte]
#define Delta_T         0.05             //Execution interval[s]
#define d_interval      0.1              //debug interval[s]
#define sensor_interval 0.05             //Sensor update interval[s]
